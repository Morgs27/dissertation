...
import { transformExpression, isArrayExpression, generateJS } from '../../src/simulation/compiler/expressionAST';
import type { ExprNode } from '../../src/simulation/compiler/expressionAST';
    ...
    describe('transformExpression', () => {
        ...
        describe('real-world expressions', () => {
            it('should handle (avgVx - vx) * inputs.alignmentFactor', () => {
                const result = transformExpression('(avgVx - vx) * inputs.alignmentFactor');
                expect(result).toContain('f(');
