...
export class ComputeEngine {
    ...
    private prepareFrameInputs(method: Method, inputValues: InputValues): PreparedFrame {
        ...
        const externalTrailMap = inputs.trailMap instanceof Float32Array ? inputs.trailMap : undefined;
    ...
    private logPerformance(method: string, agentCount: number, details: MethodPerformanceDetails) {
