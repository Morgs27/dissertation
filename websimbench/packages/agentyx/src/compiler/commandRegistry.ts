...
export interface DSLCommand {
    ...
    emit(argument: string, target: CompilerTarget, ctx: CompilationContext): string[];
}
...
function arg(argument: string, target: CompilerTarget, ctx: CompilationContext): string {
