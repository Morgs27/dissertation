...
export class Renderer {
     ...
     */
    public renderTrails(trailMap: Float32Array, width: number, height: number): void {
        const ctx = this.ensureContext();
     ...
     */
    public async renderAgentsGPU(agents: Agent[], resources?: WebGPURenderResources, trailMap?: Float32Array): Promise<void> {
                ...
                buffers: [
                    { arrayStride: 2 * GPU_FLOAT_SIZE, attributes: [{ shaderLocation: 0, format: 'float32x2' as GPUVertexFormat, offset: 0 }] },
                    {
                        arrayStride: GPU_AGENT_STRIDE, stepMode: 'instance' as GPUVertexStepMode, attributes: [
                            { shaderLocation: 1, format: 'float32x2' as GPUVertexFormat, offset: GPU_FLOAT_SIZE },
                            { shaderLocation: 2, format: 'float32' as GPUVertexFormat, offset: 5 * GPU_FLOAT_SIZE },
                        ]
                    },
                ],
            },
     ...
     * @internal
     */
    private executeRender(device: GPUDevice, resources: WebGPURenderResources, trailBuffer?: GPUBuffer): void {
