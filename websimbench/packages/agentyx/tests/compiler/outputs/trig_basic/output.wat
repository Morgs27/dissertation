  ...
  (module
    ...
    (global $inputs_angle (export "inputs_angle") (mut f32) (f32.const 0))
  ...
  (global $inputs_height (export "inputs_height") (mut f32) (f32.const 0))
    ...
    ;; execute DSL
    (local.set $__c (call $cos (global.get $inputs_angle)))
    (local.set $__s (call $sin (global.get $inputs_angle)))
