...
export class Simulation {
    ...
    constructor({ canvas, gpuCanvas, options, agentScript }: SimulationConstructor) {
        ...
        this.Renderer = new Renderer(canvas, gpuCanvas);
        this.Grapher = new Grapher(canvas);

        this.ComputeEngine = new ComputeEngine(compilationResult, this.PerformanceMonitor, options.agents);
